...
DETECTOR_CHANNELS    = (32, 64, 128, 256)  # encoder channels — memory-friendly

# Focal + Dice loss weights
DETECTOR_FOCAL_GAMMA = 2.0
DETECTOR_BCE_WEIGHT  = 0.5
DETECTOR_DICE_WEIGHT = 0.5

# Positive sample: voxels within nodule sphere
# Gaussian label smoothing on nodule sphere
GAUSSIAN_SIGMA_RATIO = 0.25   # sigma = radius * 0.25
...
# ─────────────────────────────────────────────
DETECTION_THRESHOLD   = 0.5      # sigmoid output threshold
